...
ellipsoidalLocus[mu_, sigma_] :=
  Module[{esystem, esystemT, acc, prec, delta, sorted, r, dir,chopfun},
    ...
    chopfun[delta_] := If[NumberQ[delta], Chop[#, delta], #] &;
    (* radii are square roots of eigenvalues *)
    esystemT = Transpose[MapAt[Sqrt[chopfun[delta][#]]&, esystem, 1]];
