...
kernelInit[kernels:{___?subQ}] := kernelInit /@ kernels

kernelInit[kernel_?subQ] :=
	With[{link = LinkObject[kernel]},
		MathLink`LinkSetPrintFullSymbols[link, True]; (* make sure symbols arrive in one piece *)
		kernel
	]
