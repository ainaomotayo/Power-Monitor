...
If[ !ValueQ[$mathkernel], $mathkernel = Which[
	$OperatingSystem==="Windows", dqs[ToFileName[{$InstallationDirectory}, "WolframKernel.exe"]] <> stdargs <> " -wstp -noicon",
	$OperatingSystem==="MacOSX", dqs[ToFileName[{$InstallationDirectory, "MacOS"}, "WolframKernel"]] <> stdargs <> " -wstp",
	True, dqs[ToFileName[{$InstallationDirectory, "Executables"}, "wolfram"]] <> stdargs <> " -wstp"
	];
