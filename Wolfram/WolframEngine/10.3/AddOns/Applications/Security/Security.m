...
`Information`$CreationID = If[SyntaxQ["137"], ToExpression["137"], 0]
`Information`$CreationDate = If[SyntaxQ["{2015, 12, 27, 20, 35, 03}"], ToExpression["{2015, 12, 27, 20, 35, 03}"], {0,0,0,0,0,0}]
