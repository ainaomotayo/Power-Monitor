...
(*interval functions*)
quantityIntervalMemberQ[x_?QuantityQ, y_]/; $AlphaFlag =!= True := TrueQ[QuantityIntervalQ[x, y]]
quantityIntervalMemberQ[__] := Throw["QuantityUpValueReturnUnevaluated","QuantityUpValueFlag"]

quantityIntervalUnion[x_?QuantityQ, y_?QuantityQ] /; $AlphaFlag =!= True := With[
...
quantityRound[x_?QuantityQ,y___] /; $AlphaFlag =!= True := With[{res = iQuantityRound[x,y]}, 
	If[res === $Failed, 
		Throw["QuantityUpValueReturnUnevaluated","QuantityUpValueFlag"],
		res]
]
...
quantityRound[x_?QuantityQ,y___] := With[{res = iQuantityRescale[x,y]}, 
	If[res === $Failed, 
		Throw["QuantityUpValueReturnUnevaluated","QuantityUpValueFlag"],
		res]
]
...
quantitySign[(Quantity[m_,unit_,opts___])?QuantityQ] := Sign[m/.None->1]
quantitySign[__] := Throw["QuantityUpValueReturnUnevaluated","QuantityUpValueFlag"]

quantityAbs[(Quantity[m_,unit_,opts___])?QuantityQ] := With[{mag=Abs[m]/.Abs[None]->None}, Quantity[mag,unit,opts]]
quantityAbs[__] := Throw["QuantityUpValueReturnUnevaluated","QuantityUpValueFlag"]

quantityRe[HoldPattern[(Quantity[mag_, unit_, opts___?OptionQ])?QuantityQ]] := Quantity[Re[mag], unit, opts]
quantityRe[__] := Throw["QuantityUpValueReturnUnevaluated","QuantityUpValueFlag"]

quantityIm[HoldPattern[(Quantity[mag_, unit_, opts___?OptionQ])?QuantityQ]]:= Quantity[Im[mag], unit, opts]
quantityIm[__] := Throw["QuantityUpValueReturnUnevaluated","QuantityUpValueFlag"]

quantityNorm[HoldPattern[(Quantity[mag_, unit_, opts___?OptionQ])?QuantityQ]]:= Quantity[Norm[mag], unit, opts]
quantityNorm[HoldPattern[(Quantity[mag_, unit_, opts___?OptionQ])?QuantityQ], p_]:= Quantity[Norm[mag, p], unit, opts]
quantityNorm[__] := Throw["QuantityUpValueReturnUnevaluated","QuantityUpValueFlag"]

quantityArg[HoldPattern[(Quantity[mag_, unit_, opts___?OptionQ])?QuantityQ]]:= Quantity[Arg[mag], unit, opts]
quantityArg[__] := Throw["QuantityUpValueReturnUnevaluated","QuantityUpValueFlag"]

quantityConjugate[HoldPattern[(Quantity[mag_, unit_, opts___?OptionQ])?QuantityQ]]:= Quantity[Conjugate[mag], unit, opts]
quantityConjugate[__] := Throw["QuantityUpValueReturnUnevaluated","QuantityUpValueFlag"]

quantityUnitize[HoldPattern[(Quantity[mag_, unit_, opts___?OptionQ])?QuantityQ]] := Quantity[Unitize[mag], unit, opts]
quantityUnitize[__] := Throw["QuantityUpValueReturnUnevaluated","QuantityUpValueFlag"]

quantityFibonacci[HoldPattern[(Quantity[mag_, unit_, opts___?OptionQ])?QuantityQ]] := Quantity[Fibonacci[mag],unit,opts]
quantityFibonacci[HoldPattern[(Quantity[mag_, unit_, opts___?OptionQ])?QuantityQ], p_]:= Quantity[Fibonacci[mag,p],unit,opts]
...
quantityEvenQ[HoldPattern[(Quantity[mag_, _, ___?OptionQ])?QuantityQ]] := EvenQ[mag]
quantityEvenQ[__] := Throw["QuantityUpValueReturnUnevaluated","QuantityUpValueFlag"]

quantityOddQ[HoldPattern[(Quantity[mag_, _, ___?OptionQ])?QuantityQ]] := OddQ[mag]
quantityOddQ[__] := Throw["QuantityUpValueReturnUnevaluated","QuantityUpValueFlag"]

quantityPrimeQ[HoldPattern[(Quantity[mag_, _, ___?OptionQ])?QuantityQ]] := PrimeQ[mag]
quantityPrimeQ[__] := Throw["QuantityUpValueReturnUnevaluated","QuantityUpValueFlag"]

(*list operations*)
quantityRange[HoldPattern[x:(Quantity[_,unit_,___?OptionQ])?QuantityQ]] := With[
