...
InflationAdjust[Quantity[q_, DatedUnit[SourceUnit_, SourceDate_?DateListQ]]?QuantityQ, SourceDate_?DateListQ, opts:OptionsPattern[]] := Quantity[q, DatedUnit[SourceUnit, SourceDate]]
...
InflationAdjust[Quantity[q_, DatedUnit[SourceUnit_String, SourceDate_?DateListQ]]?QuantityQ, TargetDate_?DateListQ, opts:OptionsPattern[]] := Module[
	...
	Which[
		...
		True, Quantity[q * (endvalue/startvalue), DatedUnit[SourceUnit, TargetDate]]
	]
]
...
InflationAdjust[arg_, DatedUnit[unit_,dObj_DateObject], opts:OptionsPattern[]] := InflationAdjust[
	arg,DatedUnit[unit,getDateFromDateObject[dObj]],opts]
...
getDateFromDateObject[HoldPattern[dObj:DateObject[date_List,TimeObject[time_List,___],___?OptionQ]]]:=With[{r=DateList[dObj]},
	If[ListQ[r],Take[r,Length[date]+Length[time]],Join[date,time]]]
...
iCurrencyConvert[Quantity[q_, DatedUnit[SourceUnit_, SourceDate_]], DatedUnit[TargetUnit_String, TargetDate_List]] := Catch[Module[
	...
	Switch[api,
		_?NumberQ, value*Quantity[api, DatedUnit[TargetUnit, TargetDate]],
		"noconn", Quantity[value/ (DatedUnit[TargetUnit, TargetDate] / DatedUnit[SourceUnit, TargetDate]), DatedUnit[TargetUnit, TargetDate]],
...
InflationAdjust[Quantity[q_, SourceUnit_?(FreeQ[#, DatedUnit]&)]?QuantityQ, DatedUnit[TargetUnit_, TargetDate: _?DateListQ|_Integer], opts:OptionsPattern[]] := 
	QuantityUnits`Private`InflationAdjustUnitConvert[Quantity[q, SourceUnit/.u_String :> ToDatedUnit[u]], DatedUnit[TargetUnit, TargetDate], opts] /;QuantityUnits`Private`couldBeACurrencyQ[SourceUnit]
...
InflationAdjust[Quantity[q_, SourceUnit_]?QuantityQ, DatedUnit[TargetUnit_, TargetDate: _?DateListQ|_Integer], opts:OptionsPattern[]] := 
	QuantityUnits`Private`InflationAdjustUnitConvert[Quantity[q, SourceUnit], DatedUnit[TargetUnit, TargetDate], opts] /;QuantityUnits`Private`couldBeACurrencyQ[SourceUnit]
...
InflationAdjust[Quantity[q_, SourceUnit_?(FreeQ[#, DatedUnit]&)]?QuantityQ, TargetDate: _?DateListQ|_Integer, opts:OptionsPattern[]] := With[
	{target = Cases[SourceUnit, u_String?(QuantityUnits`Private`couldBeACurrencyQ[#]&) :> ToDatedUnit[u, TargetDate]]},
...
InflationAdjust[Quantity[q_, SourceUnit_]?QuantityQ, TargetDate: _?DateListQ|_Integer, opts:OptionsPattern[]] := With[
	{target = Cases[SourceUnit, DatedUnit[u_, _] :> DatedUnit[u, TargetDate]]}, 
...
PreferredTargetUnit[units_List] := Module[{cpi, unitsonly = DeleteDuplicates[units/.DatedUnit[u_, ___]:>u]},
	cpi = SortBy[{#, Length@CPIData[#]}&/@unitsonly, Last][[-1, 1]]
...
Clear[DateListQ]
DateListQ[x_List] := ListQ[x] && Internal`PossibleDateQ[x]
DateListQ[__] := False
