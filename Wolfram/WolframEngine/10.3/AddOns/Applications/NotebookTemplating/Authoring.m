...
$DefaultButtonSize = {Automatic, 26};
...
createExpressionBox[expr_, contentData_] :=
    Module[ {inputField},
        inputField = InputFieldBox[expr, Boxes
...
AuthoringMessageDialog[x___] := 
    If[! TrueQ[CloudSystem`$CloudNotebooks], MessageDialog[x]]
...
createRepeatingBlockDialog[xInit_, listInit_, varInit_, exprInit_,
	...
	Pane[Column[{
		...
		, ImageSize -> If[TrueQ[CloudSystem`$CloudNotebooks], 485, Automatic]
    ],
    InheritScope -> True
]
