...
validLocationQ[{lat_?NumberQ, long_?NumberQ}, callingfunc_]/;((-360<=lat<=3600)&&(-360<=long<=360)) := True;
...
validDateQ[{_?NumberQ..}, callingfunc_]:=True;
...
validTimeZoneQ[_?Internal`RealValuedNumberQ] := True;
...
resolveGeoPosition[x_GeoPosition]:=If[Length[Dimensions[x[[1]]]] === 1, Reverse[x[[1,1;;2]]], Reverse /@ x[[1, All,1;;2]]]
...
preProcessCoordinates[loc_System`BezierCurve]:=Module[{line},
	line = With[{points = 36}, Table[Evaluate[(BezierFunction @@ (loc/.x_GeoPosition :> resolveGeoPosition[x]))[s], {s, 0, 1, 1/points}]]];
	Line[line]
	]
preProcessCoordinates[loc_System`BSplineCurve]:=Module[{line},
	line = With[{points = 36}, Table[Evaluate[(BSplineFunction @@ (loc/.x_GeoPosition :> resolveGeoPosition[x]))[s], {s, 0, 1, 1/points}]]];
	Line[line]
	]
...
preProcessCoordinates[{lat_?NumberQ, long_?NumberQ}]:={long, lat}
...
Which[
	...
	validDateQ[x, callingfunc]||MatchQ[x, {_?(validDateQ[#, callingfunc]&)..}]||MatchQ[x, {_?(validDateQ[#, callingfunc]&), _?(validDateQ[#, callingfunc]&), _?NumericQ|{_?NumericQ, _String}}], "date",
...
If[!MatchQ[$GeoLocation, {_?NumberQ..}|_GeoPosition]&&!FreeQ[expandedArguments, $Location], Union[AppendTo[messages, $GeoLocation->{"geoloc"}]]];
{expandedArguments, messages}/.{$Location :> (With[{tmp=$GeoLocation}, If[!MatchQ[tmp, {_?NumberQ..}|_GeoPosition], tmp, If[!MatchQ[tmp, {_?NumberQ..}|_GeoPosition], {40.1,-88.2}, tmp]]]/.GeoPosition[x_]:>x[[1;;2]]), $Date :> DateList[], $ApplicationFunction -> Automatic, $DateTime -> Automatic}
...
(* now resolve the meaning of $ApplicationFunction depending on the other arguments *)
If[!MatchQ[$GeoLocation, {_?NumberQ..}|_GeoPosition]&&!MatchQ[cs, "Equatorial"]&&!FreeQ[expandedArguments, $Location], Union[AppendTo[messages, $GeoLocation->{"geoloc"}]]];
{expandedArguments, messages}/.{$Location :> (With[{tmp=$GeoLocation}, If[!MatchQ[tmp, {_?NumberQ..}|_GeoPosition]&&!MatchQ[cs, "Equatorial"], tmp, If[!MatchQ[tmp, {_?NumberQ..}|_GeoPosition]&&MatchQ[cs, "Equatorial"], {40.1,-88.2}, tmp]]]/.GeoPosition[x_]:>x[[1;;2]]), $Date :> DateList[], $ApplicationFunction -> Automatic}
]
...
(* now resolve the meaning of $ApplicationFunction depending on the other arguments *)
If[!MatchQ[$GeoLocation, {_?NumberQ..}|_GeoPosition]&&!FreeQ[expandedArguments, $Location], Union[AppendTo[messages, $GeoLocation->{"geoloc"}]]];
{expandedArguments, messages}/.{$Location :> (With[{tmp=$GeoLocation}, If[!MatchQ[tmp, {_?NumberQ..}|_GeoPosition], tmp, If[!MatchQ[tmp, {_?NumberQ..}|_GeoPosition], {40.1,-88.2}, tmp]]]/.GeoPosition[x_]:>x[[1;;2]]), $Date :> DateList[], $ApplicationFunction -> Automatic}
...
(* now resolve the meaning of $ApplicationFunction depending on the other arguments *)
If[!MatchQ[$GeoLocation, {_?NumberQ..}|_GeoPosition]&&!FreeQ[expandedArguments, $Location], Union[AppendTo[messages, $GeoLocation->{"geoloc"}]]];
{expandedArguments, messages}/.{$Location :> (With[{tmp=$GeoLocation}, If[!MatchQ[tmp, {_?NumberQ..}|_GeoPosition], tmp, If[!MatchQ[tmp, {_?NumberQ..}|_GeoPosition], {40.1,-88.2}, tmp]]]/.GeoPosition[x_]:>x[[1;;2]]), $Date :> DateList[], $LocationQualifier -> "Everywhere"}
...
getCoordinates[loc_Entity]:= Module[{polys, redpolys,geocode=EntityValue[loc, "Position"]/.gp_GeoPosition:>QuantityMagnitude[{Latitude[gp], Longitude[gp]}]},
	...
	redpolys=If[!MatchQ[polys, {}], Cases[
		Graphics`Mesh`SimplifyPolyLine[#, VerticesGoal -> 10]&/@Cases[{polys}, _Polygon, Infinity], 
			{lat_?NumberQ, long_?NumberQ}:>{long, lat}, Infinity], polys];
...
getCoordinates[loc_Polygon]:=Replace[Map[If[MatchQ[#, {_?angleUnitQ, _?angleUnitQ}], getCoordinates[#], #]&, Map[If[MatchQ[#, _Entity], Sequence@@getCoordinates[#], #] &, Cases[loc, {_?NumberQ, _?NumberQ} | {_?angleUnitQ, _?angleUnitQ}| _Entity, Infinity]]], {{long_?NumberQ, lat_?NumberQ}} :> {Mod[long, 360, -180], Mod[lat, -90, 90]}]
getCoordinates[loc_Line]:=Replace[Map[If[MatchQ[#, {_?angleUnitQ, _?angleUnitQ}], getCoordinates[#], #]&, Map[If[MatchQ[#, _Entity], Sequence@@getCoordinates[#], #] &, Cases[loc, {_?NumberQ, _?NumberQ} | {_?angleUnitQ, _?angleUnitQ}| _Entity, Infinity]]], {{long_?NumberQ, lat_?NumberQ}} :> {Mod[long, 360, -180], Mod[lat, -90, 90]}]
getCoordinates[loc_Point]:=Replace[Map[If[MatchQ[#, {_?angleUnitQ, _?angleUnitQ}], getCoordinates[#], #]&, Map[If[MatchQ[#, _Entity], Sequence@@getCoordinates[#], #] &, Cases[loc, {_?NumberQ, _?NumberQ} | {_?angleUnitQ, _?angleUnitQ}| _Entity, Infinity]]], {{long_?NumberQ, lat_?NumberQ}} :> {Mod[long, 360, -180], Mod[lat, -90, 90]}]
getCoordinates[loc_GeoPosition]:=With[{tmp=GeoPosition[loc[[1,1;;2]]]},Replace[Map[If[MatchQ[#, {_?angleUnitQ, _?angleUnitQ}], getCoordinates[#], #]&, Map[If[MatchQ[#, _Entity], Sequence@@getCoordinates[#], #] &, Cases[tmp, {_?NumberQ, _?NumberQ} | {_?angleUnitQ, _?angleUnitQ}| _Entity, Infinity]]], {{lat_?NumberQ, long_?NumberQ}} :> {Mod[long, 360, -180], Mod[lat, -90, 90]}]]
(*getCoordinates[loc_GeoDisk]:=Replace[Map[If[MatchQ[#, {_?angleUnitQ, _?angleUnitQ}], getCoordinates[#], #]&, Map[If[MatchQ[#, _MWAEntity], Sequence@@getCoordinates[#], #] &, Cases[loc, {_?NumberQ, _?NumberQ} | {_?angleUnitQ, _?angleUnitQ}| _MWAEntity, Infinity]]], {{x_?NumberQ, y_?NumberQ}} :> {x, y}]
getCoordinates[loc_GeoArrow]:=Replace[Map[If[MatchQ[#, {_?angleUnitQ, _?angleUnitQ}], getCoordinates[#], #]&, Map[If[MatchQ[#, _MWAEntity], Sequence@@getCoordinates[#], #] &, Cases[loc, {_?NumberQ, _?NumberQ} | {_?angleUnitQ, _?angleUnitQ}| _MWAEntity, Infinity]]], {{x_?NumberQ, y_?NumberQ}} :> {x, y}]
getCoordinates[loc_GeodesicArrow]:=Replace[Map[If[MatchQ[#, {_?angleUnitQ, _?angleUnitQ}], getCoordinates[#], #]&, Map[If[MatchQ[#, _MWAEntity], Sequence@@getCoordinates[#], #] &, Cases[loc, {_?NumberQ, _?NumberQ} | {_?angleUnitQ, _?angleUnitQ}| _MWAEntity, Infinity]]], {{x_?NumberQ, y_?NumberQ}} :> {x, y}]
getCoordinates[loc_GeodesicLine]:=Replace[Map[If[MatchQ[#, {_?angleUnitQ, _?angleUnitQ}], getCoordinates[#], #]&, Map[If[MatchQ[#, _MWAEntity], Sequence@@getCoordinates[#], #] &, Cases[loc, {_?NumberQ, _?NumberQ} | {_?angleUnitQ, _?angleUnitQ}| _MWAEntity, Infinity]]], {{x_?NumberQ, y_?NumberQ}} :> {x, y}]
getCoordinates[loc_GeoMarker]:=Replace[Map[If[MatchQ[#, {_?angleUnitQ, _?angleUnitQ}], getCoordinates[#], #]&, Map[If[MatchQ[#, _MWAEntity], Sequence@@getCoordinates[#], #] &, Cases[loc, {_?NumberQ, _?NumberQ} | {_?angleUnitQ, _?angleUnitQ}| _MWAEntity, Infinity]]], {{x_?NumberQ, y_?NumberQ}} :> {x, y}]*)
...
getCoordinates[{long_?NumberQ, lat_?NumberQ}]:={long, lat}
...
Clear[getTimeZone];
getTimeZone[{n1_?NumberQ, n2_?NumberQ}]:= If[MatchQ[$GeoLocation, GeoPosition[{n1, n2}]], $TimeZone, LocalTimeZone[GeoPosition[{n1, n2}]]]
getTimeZone[loc_]:= LocalTimeZone[loc]

solarRiseTimeAndCheckForPolarM10[longlat_, gmttime_, eventincr_, tz_] := Module[{nextrise, msun, pnight},
  If[CleanQ[longlat],
   nextrise = PlanetaryAstronomy`Private`RiseSetsX["Sun", gmttime, longlat, -1, 1/1440,"Number"->1]/.lst_List:>(lst+{0,0,0,tz,0,0})[[;;5]];
   If[CleanQ[nextrise],
    nextrise, 
    msun = PlanetaryAstronomy`Private`MidnightSun3[gmttime, longlat, -1, 1/1440, "Number" -> 0][[1, All]];
    pnight = PlanetaryAstronomy`Private`MidnightSun3[gmttime, longlat, 1, 1/1440, "Number" -> 0][[1, All]];
    Which[
    	IntervalMemberQ[Interval[AbsoluteTime/@msun], AbsoluteTime@gmttime], 
    	If[eventincr===1, 
    		PlanetaryAstronomy`Private`RiseSetsX["Sun", msun[[2]], longlat, -1, 1/1440,"Number"->1]/.lst_List:>(lst+{0,0,0,tz,0,0})[[;;5]], 
    		PlanetaryAstronomy`Private`RiseSetsX["Sun", msun[[1]], longlat, -1, 1/1440,"Number"->1]/.lst_List:>(lst+{0,0,0,tz,0,0})[[;;5]]
    		],
    	IntervalMemberQ[Interval[AbsoluteTime/@pnight], AbsoluteTime@gmttime], 
    	If[eventincr===1, 
    		PlanetaryAstronomy`Private`RiseSetsX["Sun", pnight[[2]], longlat, -1, 1/1440,"Number"->1]/.lst_List:>(lst+{0,0,0,tz,0,0})[[;;5]], 
    		PlanetaryAstronomy`Private`RiseSetsX["Sun", pnight[[1]]-{0,0,1,0,0,0}, longlat, -1, 1/1440,"Number"->1]/.lst_List:>(lst+{0,0,0,tz,0,0})[[;;5]]
    		],
    	True, Missing["NotAvailable"]
    ]], Missing["NotAvailable"]]]

solarSetTimeAndCheckForPolarM10[longlat_, gmttime_, eventincr_, tz_] := Module[{nextset, msun, pnight},
  If[CleanQ[longlat],
   nextset = PlanetaryAstronomy`Private`RiseSetsX["Sun", gmttime, longlat, 1, 1/1440,"Number"->1]/.lst_List:>(lst+{0,0,0,tz,0,0})[[;;5]];
   If[CleanQ[nextset],
    nextset, 
    msun = PlanetaryAstronomy`Private`MidnightSun3[gmttime, longlat, -1, 1/1440, "Number" -> 0][[1, All]];
    pnight = PlanetaryAstronomy`Private`MidnightSun3[gmttime, longlat, 1, 1/1440, "Number" -> 0][[1, All]];
    Which[
    	...
    	If[eventincr===1, 
    		PlanetaryAstronomy`Private`RiseSetsX["Sun", msun[[2]], longlat, 1, 1/1440,"Number"->1]/.lst_List:>(lst+{0,0,0,tz,0,0})[[;;5]], 
    		PlanetaryAstronomy`Private`RiseSetsX["Sun", msun[[1]]-{0,0,1,0,0,0}, longlat, 1, 1/1440,"Number"->1]/.lst_List:>(lst+{0,0,0,tz,0,0})[[;;5]]
    		],
    	IntervalMemberQ[Interval[AbsoluteTime/@pnight], AbsoluteTime@gmttime], 
    	If[eventincr===1, 
    		PlanetaryAstronomy`Private`RiseSetsX["Sun", pnight[[2]], longlat, 1, 1/1440,"Number"->1]/.lst_List:>(lst+{0,0,0,tz,0,0})[[;;5]], 
    		PlanetaryAstronomy`Private`RiseSetsX["Sun", pnight[[1]], longlat, 1, 1/1440,"Number"->1]/.lst_List:>(lst+{0,0,0,tz,0,0})[[;;5]]
    		],
    	True, Missing["NotAvailable"]
    ]], Missing["NotAvailable"]]]
...
(* Sunrise *)
AstronomyConvenienceFunction["Sunrise", loc_?(validLocationQ[#, Sunrise]&), date:{_?NumberQ..}, utz_, tz_, ugeoloc_, eventincr_, intervalvalue_]:= Module[{idate, lat, long, coords, rangeres,res},
	...
	If[CleanQ[coords]&&Length[Dimensions[coords]]>1, 
		...
		{long, lat} = If[MatchQ[coords, {_?NumberQ, _?NumberQ}], coords, {Missing["NotAvailable"], Missing["NotAvailable"]}];
		If[!MatchQ[{long, lat}, {_?NumberQ, _?NumberQ}], Return[Missing["InvalidCoordinates"]]];
		res=solarRiseTimeAndCheckForPolarM10[{long, lat}, idate, eventincr, tz];
		getIntervalResult[res, intervalvalue, loc]
	]
 ]

AstronomyConvenienceFunction["Sunrise", loc_?(validLocationQ[#, Sunrise]&), date:{{_?NumberQ..}..}, utz_, tz_, ugeoloc_, eventincr_, intervalvalue_]:= Module[{res, idates, lat, long, coords, rangeres},
	...
	If[CleanQ[coords]&&Length[Dimensions[coords]]>1, 
		...
		{long, lat} = If[MatchQ[coords, {_?NumberQ, _?NumberQ}], coords, {Missing["NotAvailable"], Missing["NotAvailable"]}];
		If[!MatchQ[{long, lat}, {_?NumberQ, _?NumberQ}], Return[Missing["InvalidCoordinates"]]];
		res=solarRiseTimeAndCheckForPolarM10[{long, lat}, #, eventincr, tz]&/@idates;
		DeleteDuplicates[Transpose[{date,getIntervalResult[#, intervalvalue, loc]&/@res}]]]
 ];

AstronomyConvenienceFunction["Sunrise", loc:{(_?(validLocationQ[#, Sunrise]&))..}, date:{_?NumberQ..}, utz_, tz_, ugeoloc_, eventincr_, intervalvalue_]:= Module[{idate, lat, long, coords, rangeres, res},
	idate = If[eventincr===1, astroToGMT[date, utz], DateList[astroToGMT[date, utz]-{0,0,1,0,0,0}]];
	Function[{location},
...
AstronomyConvenienceFunction["Sunrise", loc:{(_?(validLocationQ[#, Sunrise]&))..}, date:{{_?NumberQ..}..}, utz_, tz_, ugeoloc_, eventincr_, intervalvalue_]:= Module[{res, idates, lat, long, coords, rangeres},
	idates = If[eventincr===1, astroToGMT[#, utz], DateList[astroToGMT[#, utz]-{0,0,1,0,0,0}]]&/@date;
	Function[{location},
		coords = getCoordinates[location];
		If[CleanQ[coords]&&Length[Dimensions[coords]]>1, 
...
AstronomyConvenienceFunction["Sunrise", locdatepairs:{{(_?(validLocationQ[#, Sunrise]&)),{_?NumberQ..}}..}, utz_, tz_, ugeoloc_, eventincr_, intervalvalue_]:= Module[{idate, lat, long, coords, rangeres, res},
	Function[{pair},
...
(* Sunset *)
AstronomyConvenienceFunction["Sunset", loc_?(validLocationQ[#, Sunset]&), date:{_?NumberQ..}, utz_, tz_, ugeoloc_, eventincr_, intervalvalue_]:= Module[{idate, lat, long, coords, rangeres,res},
	idate = If[eventincr===1, astroToGMT[date, utz], DateList[astroToGMT[date, utz]-{0,0,1,0,0,0}]];
	coords = getCoordinates[loc];
	If[CleanQ[coords]&&Length[Dimensions[coords]]>1, 
		...
		{long, lat} = If[MatchQ[coords, {_?NumberQ, _?NumberQ}], coords, {Missing["NotAvailable"], Missing["NotAvailable"]}];
		If[!MatchQ[{long, lat}, {_?NumberQ, _?NumberQ}], Return[Missing["InvalidCoordinates"]]];
		res=solarSetTimeAndCheckForPolarM10[{long, lat}, idate, eventincr, tz];
		getIntervalResult[res, intervalvalue, loc]
	]
 ];

AstronomyConvenienceFunction["Sunset", loc_?(validLocationQ[#, Sunset]&), date:{{_?NumberQ..}..}, utz_, tz_, ugeoloc_, eventincr_, intervalvalue_]:= Module[{res, idates, lat, long, coords, rangeres},
	idates = If[eventincr===1, astroToGMT[#, utz], DateList[astroToGMT[#, utz]-{0,0,1,0,0,0}]]&/@date;
	coords = getCoordinates[loc];
	If[CleanQ[coords]&&Length[Dimensions[coords]]>1, 
		...
		{long, lat} = If[MatchQ[coords, {_?NumberQ, _?NumberQ}], coords, {Missing["NotAvailable"], Missing["NotAvailable"]}];
		If[!MatchQ[{long, lat}, {_?NumberQ, _?NumberQ}], Return[Missing["InvalidCoordinates"]]];
		res=solarSetTimeAndCheckForPolarM10[{long, lat}, #, eventincr, tz]&/@idates;
		DeleteDuplicates[Transpose[{date,getIntervalResult[#, intervalvalue, loc]&/@res}]]]
 ];

AstronomyConvenienceFunction["Sunset", loc:{(_?(validLocationQ[#, Sunset]&))..}, date:{_?NumberQ..}, utz_, tz_, ugeoloc_, eventincr_, intervalvalue_]:= Module[{idate, lat, long, coords, rangeres, res},
	idate = If[eventincr===1, astroToGMT[date, utz], DateList[astroToGMT[date, utz]-{0,0,1,0,0,0}]];
	Function[{location},
		coords = getCoordinates[location];
		If[CleanQ[coords]&&Length[Dimensions[coords]]>1, 
...
AstronomyConvenienceFunction["Sunset", loc:{(_?(validLocationQ[#, Sunset]&))..}, date:{{_?NumberQ..}..}, utz_, tz_, ugeoloc_, eventincr_, intervalvalue_]:= Module[{res, idates, lat, long, coords, rangeres},
	idates = If[eventincr===1, astroToGMT[#, utz], DateList[astroToGMT[#, utz]-{0,0,1,0,0,0}]]&/@date;
	Function[{location},
		coords = getCoordinates[location];
		If[CleanQ[coords]&&Length[Dimensions[coords]]>1, 
...
AstronomyConvenienceFunction["Sunset", locdatepairs:{{(_?(validLocationQ[#, Sunset]&)),{_?NumberQ..}}..}, utz_, tz_, ugeoloc_, eventincr_, intervalvalue_]:= Module[{idate, lat, long, coords, rangeres, res},
	Function[{pair},
		idate = If[eventincr===1, astroToGMT[pair[[2]], utz], DateList[astroToGMT[pair[[2]], utz]-{0,0,1,0,0,0}]];
		coords = getCoordinates[pair[[1]]];
		If[CleanQ[coords]&&Length[Dimensions[coords]]>1, 
...
(* SunPosition *)
AstronomyConvenienceFunction["SunPosition", loc_?(validLocationQ[#, SunPosition]&), date:{_?NumberQ..}, coordsys_, utz_, tz_, ugeoloc_, intervalvalue_, altm_]:= Module[{az, alt, ra, dec, long, lat, coords, altrange, azrange, dims},
	coords = getCoordinates[loc];
	dims = Dimensions[coords];
	If[Length[dims]>1,
		If[coordsys === "Equatorial",
			ra = PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[date, utz], "RightAscension"]/.n_?NumberQ:>Quantity[SetAccuracy[n, 4], "HoursOfRightAscension"];
			dec = PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[date, utz], "Declination"]/.n_?NumberQ:>Quantity[SetAccuracy[n, 4], "AngularDegrees"];
			getIntervalResultForQuantityPairs[{Table[ra, {dims[[1]]}], Table[dec, {dims[[1]]}]}, intervalvalue, loc]/.{$Failed, $Failed}->{Missing["NotAvailable"], Missing["NotAvailable"]},
			azrange=Sort[Select[(PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[date, utz], "Azimuth", "Latitude" -> #[[2]], "Longitude" -> #[[1]]]/.n_?NumberQ:>Quantity[SetAccuracy[n, 3], "AngularDegrees"])&/@(coords),CleanQ[#]&]];
			altrange=Sort[Select[(PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[date, utz], "Altitude", "Latitude" -> #[[2]], "Longitude" -> #[[1]]]/.n_?NumberQ:>Quantity[SetAccuracy[If[MatchQ[altm, "ApparentAltitude"], n + (1.02 Cot[(n + 10.3/(n + 5.11)) Degree])/60., n], 3], "AngularDegrees"])&/@(coords),CleanQ[#]&]];
		...
		{long, lat} = If[MatchQ[coords, {_?NumberQ, _?NumberQ}], coords, {Missing["NotAvailable"], Missing["NotAvailable"]}];
		If[!MatchQ[{long, lat}, {_?NumberQ, _?NumberQ}]&&!MatchQ[coordsys, "Equatorial"], Return[Missing["InvalidCoordinates"]]];
		If[coordsys === "Equatorial", 
			ra = PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[date, utz], "RightAscension"]/.n_?NumberQ:>Quantity[SetAccuracy[n, 4], "HoursOfRightAscension"];
			dec = PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[date, utz], "Declination"]/.n_?NumberQ:>Quantity[SetAccuracy[n, 4], "AngularDegrees"];
			getIntervalResultForQuantityPairs[{ra, dec}, intervalvalue, loc]/.{$Failed, $Failed}->{Missing["NotAvailable"], Missing["NotAvailable"]},
			az = PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[date, utz], "Azimuth", "Latitude" -> lat, "Longitude" -> long]/.n_?NumberQ:>Quantity[SetAccuracy[n, 3], "AngularDegrees"];
			alt = PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[date, utz], "Altitude", "Latitude" -> lat, "Longitude" -> long]/.n_?NumberQ:>Quantity[SetAccuracy[If[MatchQ[altm, "ApparentAltitude"], n + (1.02 Cot[(n + 10.3/(n + 5.11)) Degree])/60., n], 3], "AngularDegrees"];
			getIntervalResultForQuantityPairs[{az, alt}, intervalvalue, loc]/.{$Failed, $Failed}->{Missing["NotAvailable"], Missing["NotAvailable"]}
		]
	]
	];
	
AstronomyConvenienceFunction["SunPosition", loc_?(validLocationQ[#, SunPosition]&), date:{{_?NumberQ..}..}, coordsys_, utz_, tz_, ugeoloc_, intervalvalue_, altm_]:= Module[{az, alt, ra, dec, long, lat, coords, azrange, altrange, dims},
	coords = getCoordinates[loc];
	dims = Dimensions[coords];
	If[Length[dims]>1, 
		If[coordsys === "Equatorial", 
			ra = With[{tmp=PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[#, utz], "RightAscension"]/.n_?NumberQ:>Quantity[SetAccuracy[n, 4], "HoursOfRightAscension"]}, Table[tmp, {dims[[1]]}]]&/@date;
			dec = With[{tmp=PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[#, utz], "Declination"]/.n_?NumberQ:>Quantity[SetAccuracy[n, 4], "AngularDegrees"]}, Table[tmp, {dims[[1]]}]]&/@date;
			...
			azrange = Function[{idate}, Sort[Select[(PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[idate, utz], "Azimuth", "Latitude" -> #[[2]], "Longitude" -> #[[1]]]/.n_?NumberQ:>Quantity[SetAccuracy[n, 3], "AngularDegrees"])&/@(coords), CleanQ[#]&]]]/@date;
			altrange = Function[{idate}, Sort[Select[(PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[idate, utz], "Altitude", "Latitude" -> #[[2]], "Longitude" -> #[[1]]]/.n_?NumberQ:>Quantity[SetAccuracy[If[MatchQ[altm, "ApparentAltitude"], n + (1.02 Cot[(n + 10.3/(n + 5.11)) Degree])/60., n], 3], "AngularDegrees"])&/@(coords), CleanQ[#]&]]]/@date;
			DeleteDuplicates[Transpose[{date, ((getIntervalResultForQuantityPairs[#, intervalvalue, loc])&/@Transpose[{azrange,altrange}])}]]],
		{long, lat} = If[MatchQ[coords, {_?NumberQ, _?NumberQ}], coords, {Missing["NotAvailable"], Missing["NotAvailable"]}];
		If[!MatchQ[{long, lat}, {_?NumberQ, _?NumberQ}]&&!MatchQ[coordsys, "Equatorial"], Return[Missing["InvalidCoordinates"]]];
		If[coordsys === "Equatorial", 
			ra = ((PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[#, utz], "RightAscension"]/.n_?NumberQ:>Quantity[SetAccuracy[n, 4], "HoursOfRightAscension"])&/@date);
			dec = ((PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[#, utz], "Declination"]/.n_?NumberQ:>Quantity[SetAccuracy[n, 4], "AngularDegrees"])&/@date);
			DeleteDuplicates[Transpose[{date, (getIntervalResultForQuantityPairs[#, intervalvalue, loc]&/@Transpose[{ra, dec}])/.{$Failed, $Failed}->{Missing["NotAvailable"], Missing["NotAvailable"]}}]],
			az = ((PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[#, utz], "Azimuth", "Latitude" -> lat, "Longitude" -> long]/.n_?NumberQ:>Quantity[SetAccuracy[n, 3], "AngularDegrees"])&/@date);
			alt = ((PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[#, utz], "Altitude", "Latitude" -> lat, "Longitude" -> long]/.n_?NumberQ:>Quantity[SetAccuracy[If[MatchQ[altm, "ApparentAltitude"], n + (1.02 Cot[(n + 10.3/(n + 5.11)) Degree])/60., n], 3], "AngularDegrees"])&/@date); 
...
AstronomyConvenienceFunction["SunPosition", locs:{(_?(validLocationQ[#, SunPosition]&))..}, date:{_?NumberQ..}, coordsys_, utz_, tz_, ugeoloc_, intervalvalue_, altm_]:= Module[{az, alt, ra, dec, long, lat, coords, altrange, azrange, dims},
	Function[{location},
	coords = getCoordinates[location];
	dims = Dimensions[coords];
	If[Length[dims]>1,
		If[coordsys === "Equatorial",
			ra = PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[date, utz], "RightAscension"]/.n_?NumberQ:>Quantity[SetAccuracy[n, 4], "HoursOfRightAscension"];
			dec = PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[date, utz], "Declination"]/.n_?NumberQ:>Quantity[SetAccuracy[n, 4], "AngularDegrees"];
			getIntervalResultForQuantityPairs[{Table[ra, {dims[[1]]}], Table[dec, {dims[[1]]}]}, intervalvalue, location]/.{$Failed, $Failed}->{Missing["NotAvailable"], Missing["NotAvailable"]},
			azrange=Sort[Select[(PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[date, utz], "Azimuth", "Latitude" -> #[[2]], "Longitude" -> #[[1]]]/.n_?NumberQ:>Quantity[SetAccuracy[n, 3], "AngularDegrees"])&/@(coords),CleanQ[#]&]];
			altrange=Sort[Select[(PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[date, utz], "Altitude", "Latitude" -> #[[2]], "Longitude" -> #[[1]]]/.n_?NumberQ:>Quantity[SetAccuracy[If[MatchQ[altm, "ApparentAltitude"], n + (1.02 Cot[(n + 10.3/(n + 5.11)) Degree])/60., n], 3], "AngularDegrees"])&/@(coords),CleanQ[#]&]];
...
AstronomyConvenienceFunction["SunPosition", loc:{(_?(validLocationQ[#, SunPosition]&))..}, date:{{_?NumberQ..}..}, coordsys_, utz_, tz_, ugeoloc_, intervalvalue_, altm_]:= Module[{az, alt, ra, dec, long, lat, coords, azrange, altrange, dims},
	Function[{location},
	coords = getCoordinates[location];
	dims = Dimensions[coords];
	If[Length[dims]>1, 
...
AstronomyConvenienceFunction["SunPosition", locdatepairs:{{(_?(validLocationQ[#, SunPosition]&)), {_?NumberQ..}}..}, coordsys_, utz_, tz_, ugeoloc_, intervalvalue_, altm_]:= Module[{az, alt, ra, dec, long, lat, coords, altrange, azrange, dims},
	Function[{pair},
	coords = getCoordinates[pair[[1]]];
	dims = Dimensions[coords];
	If[Length[dims]>1,
		If[coordsys === "Equatorial",
			ra = PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[pair[[2]], utz], "RightAscension"]/.n_?NumberQ:>Quantity[SetAccuracy[n, 4], "HoursOfRightAscension"];
			dec = PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[pair[[2]], utz], "Declination"]/.n_?NumberQ:>Quantity[SetAccuracy[n, 4], "AngularDegrees"];
			getIntervalResultForQuantityPairs[{Table[ra, {dims[[1]]}], Table[dec, {dims[[1]]}]}, intervalvalue, pair[[1]]]/.{$Failed, $Failed}->{Missing["NotAvailable"], Missing["NotAvailable"]},
			azrange=Sort[Select[(PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[pair[[2]], utz], "Azimuth", "Latitude" -> #[[2]], "Longitude" -> #[[1]]]/.n_?NumberQ:>Quantity[SetAccuracy[n, 3], "AngularDegrees"])&/@(coords),CleanQ[#]&]];
			altrange=Sort[Select[(PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[pair[[2]], utz], "Altitude", "Latitude" -> #[[2]], "Longitude" -> #[[1]]]/.n_?NumberQ:>Quantity[SetAccuracy[If[MatchQ[altm, "ApparentAltitude"], n + (1.02 Cot[(n + 10.3/(n + 5.11)) Degree])/60., n], 3], "AngularDegrees"])&/@(coords),CleanQ[#]&]];
		...
		If[coordsys === "Equatorial", 
			...
			az = PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[pair[[2]], utz], "Azimuth", "Latitude" -> lat, "Longitude" -> long]/.n_?NumberQ:>Quantity[SetAccuracy[n, 3], "AngularDegrees"];
			alt = PlanetaryAstronomy`PreAstronomyData["Sun", astroToGMT[pair[[2]], utz], "Altitude", "Latitude" -> lat, "Longitude" -> long]/.n_?NumberQ:>Quantity[SetAccuracy[If[MatchQ[altm, "ApparentAltitude"], n + (1.02 Cot[(n + 10.3/(n + 5.11)) Degree])/60., n], 3], "AngularDegrees"];
...
AstronomyConvenienceFunction["MoonPosition", loc_?(validLocationQ[#, MoonPosition]&), date:{_?NumberQ..}, coordsys_, utz_, tz_, ugeoloc_, intervalvalue_, altm_]:= Module[{az, alt, ra, dec, long, lat, coords, altrange, azrange, dims},
	coords = getCoordinates[loc];
	dims = Dimensions[coords];
	If[Length[dims]>1,
		If[coordsys === "Equatorial",
			ra = PlanetaryAstronomy`PreAstronomyData["Moon", astroToGMT[date, utz], "RightAscension"]/.n_?NumberQ:>Quantity[SetAccuracy[n, 4], "HoursOfRightAscension"];
			dec = PlanetaryAstronomy`PreAstronomyData["Moon", astroToGMT[date, utz], "Declination"]/.n_?NumberQ:>Quantity[SetAccuracy[n, 4], "AngularDegrees"];
			getIntervalResultForQuantityPairs[{Table[ra, {dims[[1]]}], Table[dec, {dims[[1]]}]}, intervalvalue, loc]/.{$Failed, $Failed}->{Missing["NotAvailable"], Missing["NotAvailable"]},
			azrange=Sort[Select[(PlanetaryAstronomy`PreAstronomyData["Moon", astroToGMT[date, utz], "Azimuth", "Latitude" -> #[[2]], "Longitude" -> #[[1]]]/.n_?NumberQ:>Quantity[SetAccuracy[n, 3], "AngularDegrees"])&/@(coords),CleanQ[#]&]];
			altrange=Sort[Select[(PlanetaryAstronomy`PreAstronomyData["Moon", astroToGMT[date, utz], "Altitude", "Latitude" -> #[[2]], "Longitude" -> #[[1]]]/.n_?NumberQ:>Quantity[SetAccuracy[If[MatchQ[altm, "ApparentAltitude"], n + (1.02 Cot[(n + 10.3/(n + 5.11)) Degree])/60., n], 3], "AngularDegrees"])&/@(coords),CleanQ[#]&]];
			getIntervalResultForQuantityPairs[{azrange, altrange}, intervalvalue, loc]/.{$Failed, $Failed}->{Missing["NotAvailable"], Missing["NotAvailable"]}
		],
		{long, lat} = If[MatchQ[coords, {_?NumberQ, _?NumberQ}], coords, {Missing["NotAvailable"], Missing["NotAvailable"]}];
		If[!MatchQ[{long, lat}, {_?NumberQ, _?NumberQ}]&&!MatchQ[coordsys, "Equatorial"], Return[Missing["InvalidCoordinates"]]];
		If[coordsys === "Equatorial", 
			...
			dec = PlanetaryAstronomy`PreAstronomyData["Moon", astroToGMT[date, utz], "Declination"]/.n_?NumberQ:>Quantity[SetAccuracy[n, 4], "AngularDegrees"];
			getIntervalResultForQuantityPairs[{ra, dec}, intervalvalue, loc]/.{$Failed, $Failed}->{Missing["NotAvailable"], Missing["NotAvailable"]},
			az = PlanetaryAstronomy`PreAstronomyData["Moon", astroToGMT[date, utz], "Azimuth", "Latitude" -> lat, "Longitude" -> long]/.n_?NumberQ:>Quantity[SetAccuracy[n, 3], "AngularDegrees"];
			alt = PlanetaryAstronomy`PreAstronomyData["Moon", astroToGMT[date, utz], "Altitude", "Latitude" -> lat, "Longitude" -> long]/.n_?NumberQ:>Quantity[SetAccuracy[If[MatchQ[altm, "ApparentAltitude"], n + (1.02 Cot[(n + 10.3/(n + 5.11)) Degree])/60., n], 3], "AngularDegrees"];
			getIntervalResultForQuantityPairs[{az, alt}, intervalvalue, loc]/.{$Failed, $Failed}->{Missing["NotAvailable"], Missing["NotAvailable"]}
		]
	]
	];
	
AstronomyConvenienceFunction["MoonPosition", loc_?(validLocationQ[#, MoonPosition]&), date:{{_?NumberQ..}..}, coordsys_, utz_, tz_, ugeoloc_, intervalvalue_, altm_]:= Module[{az, alt, ra, dec, long, lat, coords, azrange, altrange, dims},
	coords = getCoordinates[loc];
	dims = Dimensions[coords];
	If[Length[dims]>1, 
		If[coordsys === "Equatorial", 
			ra = With[{tmp=PlanetaryAstronomy`PreAstronomyData["Moon", astroToGMT[#, utz], "RightAscension"]/.n_?NumberQ:>Quantity[SetAccuracy[n, 4], "HoursOfRightAscension"]}, Table[tmp, {dims[[1]]}]]&/@date;
			dec = With[{tmp=PlanetaryAstronomy`PreAstronomyData["Moon", astroToGMT[#, utz], "Declination"]/.n_?NumberQ:>Quantity[SetAccuracy[n, 4], "AngularDegrees"]}, Table[tmp, {dims[[1]]}]]&/@date;
			DeleteDuplicates[Transpose[{date, (getIntervalResultForQuantityPairs[#, intervalvalue, loc]&/@Transpose[{ra, dec}])/.{$Failed, $Failed}->{Missing["NotAvailable"], Missing["NotAvailable"]}}]],
			azrange = Function[{idate}, Sort[Select[(PlanetaryAstronomy`PreAstronomyData["Moon", astroToGMT[idate, utz], "Azimuth", "Latitude" -> #[[2]], "Longitude" -> #[[1]]]/.n_?NumberQ:>Quantity[SetAccuracy[n, 3], "AngularDegrees"])&/@(coords), CleanQ[#]&]]]/@date;
			altrange = Function[{idate}, Sort[Select[(PlanetaryAstronomy`PreAstronomyData["Moon", astroToGMT[idate, utz], "Altitude", "Latitude" -> #[[2]], "Longitude" -> #[[1]]]/.n_?NumberQ:>Quantity[SetAccuracy[If[MatchQ[altm, "ApparentAltitude"], n + (1.02 Cot[(n + 10.3/(n + 5.11)) Degree])/60., n], 3], "AngularDegrees"])&/@(coords), CleanQ[#]&]]]/@date;
			DeleteDuplicates[Transpose[{date, ((getIntervalResultForQuantityPairs[#, intervalvalue, loc])&/@Transpose[{azrange,altrange}])}]]],
		{long, lat} = If[MatchQ[coords, {_?NumberQ, _?NumberQ}], coords, {Missing["NotAvailable"], Missing["NotAvailable"]}];
		If[!MatchQ[{long, lat}, {_?NumberQ, _?NumberQ}]&&!MatchQ[coordsys, "Equatorial"], Return[Missing["InvalidCoordinates"]]];
		If[coordsys === "Equatorial", 
			ra = ((PlanetaryAstronomy`PreAstronomyData["Moon", astroToGMT[#, utz], "RightAscension"]/.n_?NumberQ:>Quantity[SetAccuracy[n, 4], "HoursOfRightAscension"])&/@date);
			dec = ((PlanetaryAstronomy`PreAstronomyData["Moon", astroToGMT[#, utz], "Declination"]/.n_?NumberQ:>Quantity[SetAccuracy[n, 4], "AngularDegrees"])&/@date);
			DeleteDuplicates[Transpose[{date, (getIntervalResultForQuantityPairs[#, intervalvalue, loc]&/@Transpose[{ra, dec}])/.{$Failed, $Failed}->{Missing["NotAvailable"], Missing["NotAvailable"]}}]],
			az = ((PlanetaryAstronomy`PreAstronomyData["Moon", astroToGMT[#, utz], "Azimuth", "Latitude" -> lat, "Longitude" -> long]/.n_?NumberQ:>Quantity[SetAccuracy[n, 3], "AngularDegrees"])&/@date);
			alt = ((PlanetaryAstronomy`PreAstronomyData["Moon", astroToGMT[#, utz], "Altitude", "Latitude" -> lat, "Longitude" -> long]/.n_?NumberQ:>Quantity[SetAccuracy[If[MatchQ[altm, "ApparentAltitude"], n + (1.02 Cot[(n + 10.3/(n + 5.11)) Degree])/60., n], 3], "AngularDegrees"])&/@date); 
			DeleteDuplicates[Transpose[{date, (getIntervalResultForQuantityPairs[#, intervalvalue, loc]&/@Transpose[{az, alt}])/.{$Failed, $Failed}->{Missing["NotAvailable"], Missing["NotAvailable"]}}]]
			]
		]
...
AstronomyConvenienceFunction["MoonPosition", locs:{(_?(validLocationQ[#, MoonPosition]&))..}, date:{_?NumberQ..}, coordsys_, utz_, tz_, ugeoloc_, intervalvalue_, altm_]:= Module[{az, alt, ra, dec, long, lat, coords, altrange, azrange, dims},
	Function[{location},
	coords = getCoordinates[location];
	dims = Dimensions[coords];
	If[Length[dims]>1,
...
AstronomyConvenienceFunction["MoonPosition", loc:{(_?(validLocationQ[#, MoonPosition]&))..}, date:{{_?NumberQ..}..}, coordsys_, utz_, tz_, ugeoloc_, intervalvalue_, altm_]:= Module[{az, alt, ra, dec, long, lat, coords, azrange, altrange, dims},
	Function[{location},
	coords = getCoordinates[location];
	dims = Dimensions[coords];
	If[Length[dims]>1, 
...
AstronomyConvenienceFunction["MoonPosition", locdatepairs:{{(_?(validLocationQ[#, MoonPosition]&)), {_?NumberQ..}}..}, coordsys_, utz_, tz_, ugeoloc_, intervalvalue_, altm_]:= Module[{az, alt, ra, dec, long, lat, coords, altrange, azrange, dims},
	Function[{pair},
	coords = getCoordinates[pair[[1]]];
	dims = Dimensions[coords];
	If[Length[dims]>1,
		If[coordsys === "Equatorial",
			ra = PlanetaryAstronomy`PreAstronomyData["Moon", astroToGMT[pair[[2]], utz], "RightAscension"]/.n_?NumberQ:>Quantity[SetAccuracy[n, 4], "HoursOfRightAscension"];
			dec = PlanetaryAstronomy`PreAstronomyData["Moon", astroToGMT[pair[[2]], utz], "Declination"]/.n_?NumberQ:>Quantity[SetAccuracy[n, 4], "AngularDegrees"];
			getIntervalResultForQuantityPairs[{Table[ra, {dims[[1]]}], Table[dec, {dims[[1]]}]}, intervalvalue, pair[[1]]]/.{$Failed, $Failed}->{Missing["NotAvailable"], Missing["NotAvailable"]},
			azrange=Sort[Select[(PlanetaryAstronomy`PreAstronomyData["Moon", astroToGMT[pair[[2]], utz], "Azimuth", "Latitude" -> #[[2]], "Longitude" -> #[[1]]]/.n_?NumberQ:>Quantity[SetAccuracy[n, 3], "AngularDegrees"])&/@(coords),CleanQ[#]&]];
			altrange=Sort[Select[(PlanetaryAstronomy`PreAstronomyData["Moon", astroToGMT[pair[[2]], utz], "Altitude", "Latitude" -> #[[2]], "Longitude" -> #[[1]]]/.n_?NumberQ:>Quantity[SetAccuracy[If[MatchQ[altm, "ApparentAltitude"], n + (1.02 Cot[(n + 10.3/(n + 5.11)) Degree])/60., n], 3], "AngularDegrees"])&/@(coords),CleanQ[#]&]];
			getIntervalResultForQuantityPairs[{azrange, altrange}, intervalvalue, pair[[1]]]/.{$Failed, $Failed}->{Missing["NotAvailable"], Missing["NotAvailable"]}
		],
		{long, lat} = If[MatchQ[coords, {_?NumberQ, _?NumberQ}], coords, {Missing["NotAvailable"], Missing["NotAvailable"]}];
		If[!MatchQ[{long, lat}, {_?NumberQ, _?NumberQ}]&&!MatchQ[coordsys, "Equatorial"], Return[Missing["InvalidCoordinates"]]];
		If[coordsys === "Equatorial", 
			...
			dec = PlanetaryAstronomy`PreAstronomyData["Moon", astroToGMT[pair[[2]], utz], "Declination"]/.n_?NumberQ:>Quantity[SetAccuracy[n, 4], "AngularDegrees"];
			getIntervalResultForQuantityPairs[{ra, dec}, intervalvalue, pair[[1]]]/.{$Failed, $Failed}->{Missing["NotAvailable"], Missing["NotAvailable"]},
			az = PlanetaryAstronomy`PreAstronomyData["Moon", astroToGMT[pair[[2]], utz], "Azimuth", "Latitude" -> lat, "Longitude" -> long]/.n_?NumberQ:>Quantity[SetAccuracy[n, 3], "AngularDegrees"];
			alt = PlanetaryAstronomy`PreAstronomyData["Moon", astroToGMT[pair[[2]], utz], "Altitude", "Latitude" -> lat, "Longitude" -> long]/.n_?NumberQ:>Quantity[SetAccuracy[If[MatchQ[altm, "ApparentAltitude"], n + (1.02 Cot[(n + 10.3/(n + 5.11)) Degree])/60., n], 3], "AngularDegrees"];
			getIntervalResultForQuantityPairs[{az, alt}, intervalvalue, pair[[1]]]/.{$Failed, $Failed}->{Missing["NotAvailable"], Missing["NotAvailable"]}
		]
	]]/@locdatepairs
	];
...
AstronomyConvenienceFunction["MoonPhase", prop_, date:{_?NumberQ..}, utz_, tz_, ugeoloc_]:= Module[{},
 Switch[prop,
...
ApparentLST[longlat_, gmttime_]:=If[MatchQ[gmttime, _Missing]||CorruptQ[longlat], Missing["NotAvailable"], Mod[PlanetaryAstronomy`Private`PATransformationX[PlanetaryAstronomy`Private`PASystem[{"Earth", longlat Degree}, PlanetaryAstronomy`Private`JDU[gmttime], {0, 1.57079, 1}], "EarthEquatorial"][[3, 1]]/Degree/15, 24]/.n_?NumberQ:>Quantity[n, "HoursOfRightAscension"]]

AstronomyConvenienceFunction["SiderealTime", loc_?(validLocationQ[#, SiderealTime]&), date:{_?NumberQ..}, utz_, tz_, ugeoloc_, intervalvalue_]:= Module[{idate, lat, long, coords, rangeres,res},
...
AstronomyConvenienceFunction["SiderealTime", loc_?(validLocationQ[#, SiderealTime]&), date:{{_?NumberQ..}..}, utz_, tz_, ugeoloc_, intervalvalue_]:= Module[{st, strange, long, lat, coords, dims},
	coords = getCoordinates[loc];
	dims = Dimensions[coords];
	If[Length[dims]>1, 
...
AstronomyConvenienceFunction["SiderealTime", locs:{_?(validLocationQ[#, SiderealTime]&)..}, date:{_?NumberQ..}, utz_, tz_, ugeoloc_, intervalvalue_]:= Module[{st, strange, lat, long, coords, dims},
	Function[{location},
	coords = getCoordinates[location];
	dims = Dimensions[coords];
	If[Length[dims]>1,
...
AstronomyConvenienceFunction["SiderealTime", loc:{_?(validLocationQ[#, SiderealTime]&)..}, date:{{_?NumberQ..}..}, utz_, tz_, ugeoloc_, intervalvalue_]:= Module[{st, strange, long, lat, coords, dims},
	Function[{location},
	coords = getCoordinates[location];
	dims = Dimensions[coords];
	If[Length[dims]>1, 
...
AstronomyConvenienceFunction["SiderealTime", locdatepairs:{{_?(validLocationQ[#, SiderealTime]&), {_?NumberQ..}}..}, utz_, tz_, ugeoloc_, intervalvalue_]:= Module[{st, strange, long, lat, coords, dims},
	Function[{pair},
	coords = getCoordinates[pair[[1]]];
	dims = Dimensions[coords];
	If[Length[dims]>1,
...
(* options *)
Options[Sunrise] = {TimeZone :> $TimeZone, TimeDirection :> 1};

Options[Sunset] = {TimeZone :> $TimeZone, TimeDirection :> 1};

Options[SunPosition] = {CelestialSystem -> "Horizon", AltitudeMethod -> "TrueAltitude"};

Options[MoonPosition] = {CelestialSystem -> "Horizon", AltitudeMethod -> "TrueAltitude"};

Options[SolarEclipse] = {TimeZone :> $TimeZone, TimeDirection :> 1, EclipseType :> Automatic};

Options[LunarEclipse] = {TimeZone :> $TimeZone, TimeDirection :> 1, EclipseType :> Automatic}; 
...
fixGraphicsForGeoPosition[arg_]:=arg/.{
	Polygon[x:{{_?NumberQ,_?NumberQ}..}]:>Polygon[GeoPosition[Reverse/@x]],
	Polygon[x:{{{_?NumberQ,_?NumberQ}..}}]:>Polygon[GeoPosition[Reverse/@x[[1]]]],
	Line[x:{{_?NumberQ,_?NumberQ}..}]:>Line[GeoPosition[Reverse/@x]],
	Line[x:{{{_?NumberQ,_?NumberQ}..}}]:>Line[GeoPosition[Reverse/@x][[1]]]}
...
iSolarEclipse[OptionsPattern[SolarEclipse]] := Module[{tz, igeolocation, apiresult, ei, et, api},
  tz = TimeZoneOffset[OptionValue[TimeZone]];
  ei = OptionValue[TimeDirection]/.{"Next"|"After"|Next|After->1, "Last"|"Previous"|"Before"|Previous|Last|Before->-1};
...
iSolarEclipse[date_?(validDateQ[#, SolarEclipse]&), OptionsPattern[SolarEclipse]] := Module[{tz, igeolocation, apiresult, ei, et, api},
  tz = TimeZoneOffset[OptionValue[TimeZone]];
  ei = OptionValue[TimeDirection]/.{"Next"|"After"|Next|After->1, "Last"|"Previous"|"Before"|Previous|Last|Before->-1};
  et = OptionValue[EclipseType];
  If[!validTimeZoneQ[tz], Message[SolarEclipse::zone, tz];tz = $SystemTimeZone];
...
iSolarEclipse[date:{_?(validDateQ[#, SolarEclipse]&)..}, OptionsPattern[SolarEclipse]] := Module[{tz, igeolocation, apiresult, ei, et, api},
  tz = TimeZoneOffset[OptionValue[TimeZone]];
  ei = OptionValue[TimeDirection]/.{"Next"|"After"|Next|After->1, "Last"|"Previous"|"Before"|Previous|Last|Before->-1};
  et = OptionValue[EclipseType];
  If[!validTimeZoneQ[tz], Message[SolarEclipse::zone, tz];tz = $SystemTimeZone];
...
iSolarEclipse[{start_?(validDateQ[#, SolarEclipse]||validDateStringQ[#, SolarEclipse]&), end_?(validDateQ[#, SolarEclipse]||validDateStringQ[#, SolarEclipse]&), All}, opts:OptionsPattern[SolarEclipse]] := 
 Module[{tz, igeolocation, apiresult, ei, et, api},
  tz = TimeZoneOffset[OptionValue[TimeZone]];
  ei = OptionValue[TimeDirection]/.{"Next"|"After"|Next|After->1, "Last"|"Previous"|"Before"|Previous|Last|Before->-1};
  et = OptionValue[EclipseType];
  If[!validTimeZoneQ[tz], Message[SolarEclipse::zone, tz];tz = $SystemTimeZone];
...
iSolarEclipse[prop:"MaximumEclipseDate"|"TotalPhaseStartDate"|"TotalPhaseEndDate", OptionsPattern[SolarEclipse]] := Module[{tz, igeolocation, apiresult, ei, et, api},
  tz = TimeZoneOffset[OptionValue[TimeZone]];
  ei = OptionValue[TimeDirection]/.{"Next"|"After"|Next|After->1, "Last"|"Previous"|"Before"|Previous|Last|Before->-1};
  et = OptionValue[EclipseType];
  If[!validTimeZoneQ[tz], Message[SolarEclipse::zone, tz];tz = $SystemTimeZone];
...
iSolarEclipse[prop:"GraphicsData"|"PartialPhasePolygon"|"TotalPhasePolygon"|"TotalPhaseCenterLine"|"Type", OptionsPattern[SolarEclipse]] := Module[{tz, igeolocation, apiresult, ei, et, api},
  tz = TimeZoneOffset[OptionValue[TimeZone]];
  ei = OptionValue[TimeDirection]/.{"Next"|"After"|Next|After->1, "Last"|"Previous"|"Before"|Previous|Last|Before->-1};
  et = OptionValue[EclipseType];
  If[!validTimeZoneQ[tz], Message[SolarEclipse::zone, tz];tz = $SystemTimeZone];
...
iSolarEclipse[date_?(validDateQ[#, SolarEclipse]&), prop:"MaximumEclipseDate"|"TotalPhaseStartDate"|"TotalPhaseEndDate", OptionsPattern[SolarEclipse]] := Module[{tz, igeolocation, apiresult, ei, et, api},
  tz = TimeZoneOffset[OptionValue[TimeZone]];
  ei = OptionValue[TimeDirection]/.{"Next"|"After"|Next|After->1, "Last"|"Previous"|"Before"|Previous|Last|Before->-1};
  et = OptionValue[EclipseType];
  If[!validTimeZoneQ[tz], Message[SolarEclipse::zone, tz];tz = $SystemTimeZone];
...
iSolarEclipse[date_?(validDateQ[#, SolarEclipse]&), prop:"GraphicsData"|"PartialPhasePolygon"|"TotalPhasePolygon"|"TotalPhaseCenterLine"|"Type", OptionsPattern[SolarEclipse]] := Module[{tz, igeolocation, apiresult, ei, et, api},
  tz = TimeZoneOffset[OptionValue[TimeZone]];
  ei = OptionValue[TimeDirection]/.{"Next"|"After"|Next|After->1, "Last"|"Previous"|"Before"|Previous|Last|Before->-1};
  et = OptionValue[EclipseType];
  If[!validTimeZoneQ[tz], Message[SolarEclipse::zone, tz];tz = $SystemTimeZone];
...
iSolarEclipse[date:{_?(validDateQ[#, SolarEclipse]&)..}, prop:"GraphicsData"|"PartialPhasePolygon"|"TotalPhasePolygon"|"TotalPhaseCenterLine"|"Type"|"MaximumEclipseDate"|"TotalPhaseStartDate"|"TotalPhaseEndDate", OptionsPattern[SolarEclipse]] := Module[{tz, igeolocation, apiresult, ei, et, api},
  tz = TimeZoneOffset[OptionValue[TimeZone]];
  ei = OptionValue[TimeDirection]/.{"Next"|"After"|Next|After->1, "Last"|"Previous"|"Before"|Previous|Last|Before->-1};
  et = OptionValue[EclipseType];
  If[!validTimeZoneQ[tz], Message[SolarEclipse::zone, tz];tz = $SystemTimeZone];
...
iSolarEclipse[{start_?(validDateQ[#, SolarEclipse]||validDateStringQ[#, SolarEclipse]&), end_?(validDateQ[#, SolarEclipse]||validDateStringQ[#, SolarEclipse]&), All}, prop:"GraphicsData"|"PartialPhasePolygon"|"TotalPhasePolygon"|"TotalPhaseCenterLine"|"Type", opts:OptionsPattern[SolarEclipse]] := Module[{tz, igeolocation, apiresult, ei, et, api},
  tz = TimeZoneOffset[OptionValue[TimeZone]];
  ei = OptionValue[TimeDirection]/.{"Next"|"After"|Next|After->1, "Last"|"Previous"|"Before"|Previous|Last|Before->-1};
  et = OptionValue[EclipseType];
  If[!validTimeZoneQ[tz], Message[SolarEclipse::zone, tz];tz = $SystemTimeZone];
...
iSolarEclipse[{start_?(validDateQ[#, SolarEclipse]||validDateStringQ[#, SolarEclipse]&), end_?(validDateQ[#, SolarEclipse]||validDateStringQ[#, SolarEclipse]&), All}, prop:"MaximumEclipseDate"|"TotalPhaseStartDate"|"TotalPhaseEndDate", opts:OptionsPattern[SolarEclipse]] := Module[{tz, igeolocation, apiresult, ei, et, api},
  tz = TimeZoneOffset[OptionValue[TimeZone]];
  ei = OptionValue[TimeDirection]/.{"Next"|"After"|Next|After->1, "Last"|"Previous"|"Before"|Previous|Last|Before->-1};
  et = OptionValue[EclipseType];
  If[!validTimeZoneQ[tz], Message[SolarEclipse::zone, tz];tz = $SystemTimeZone];
...
iLunarEclipse[OptionsPattern[LunarEclipse]] := Module[{tz, igeolocation, apiresult, ei, et, api},
  tz = TimeZoneOffset[OptionValue[TimeZone]];
  ei = OptionValue[TimeDirection]/.{"Next"|"After"|Next|After->1, "Last"|"Previous"|"Before"|Previous|Last|Before->-1};
  et = OptionValue[EclipseType];
...
iLunarEclipse[date_?(validDateQ[#, LunarEclipse]&), OptionsPattern[LunarEclipse]] := Module[{tz, igeolocation, apiresult, ei, et, api},
  tz = TimeZoneOffset[OptionValue[TimeZone]];
  ei = OptionValue[TimeDirection]/.{"Next"|"After"|Next|After->1, "Last"|"Previous"|"Before"|Previous|Last|Before->-1};
  et = OptionValue[EclipseType];
  If[!validTimeZoneQ[tz], Message[LunarEclipse::zone, tz];tz = $SystemTimeZone];
...
iLunarEclipse[date:{_?(validDateQ[#, LunarEclipse]&)..}, OptionsPattern[LunarEclipse]] := Module[{tz, igeolocation, apiresult, ei, et, api},
  tz = TimeZoneOffset[OptionValue[TimeZone]];
  ei = OptionValue[TimeDirection]/.{"Next"|"After"|Next|After->1, "Last"|"Previous"|"Before"|Previous|Last|Before->-1};
  et = OptionValue[EclipseType];
  If[!validTimeZoneQ[tz], Message[LunarEclipse::zone, tz];tz = $SystemTimeZone];
...
iLunarEclipse[{start_?(validDateQ[#, LunarEclipse]||validDateStringQ[#, LunarEclipse]&), end_?(validDateQ[#, LunarEclipse]||validDateStringQ[#, LunarEclipse]&), All}, opts:OptionsPattern[LunarEclipse]] := Module[{tz, igeolocation, apiresult, ei, et, api},
  tz = TimeZoneOffset[OptionValue[TimeZone]];
  ei = OptionValue[TimeDirection]/.{"Next"|"After"|Next|After->1, "Last"|"Previous"|"Before"|Previous|Last|Before->-1};
  et = OptionValue[EclipseType];
  If[!validTimeZoneQ[tz], Message[LunarEclipse::zone, tz];tz = $SystemTimeZone];
...
iLunarEclipse[prop:"MaximumEclipseDate"|"TotalPhaseStartDate"|"TotalPhaseEndDate"|"TotalPhaseStartDate"|"PartialPhaseStartDate"|"PartialPhaseEndDate", OptionsPattern[LunarEclipse]] := Module[{tz, igeolocation, apiresult, ei, et, api},
  tz = TimeZoneOffset[OptionValue[TimeZone]];
  ei = OptionValue[TimeDirection]/.{"Next"|"After"|Next|After->1, "Last"|"Previous"|"Before"|Previous|Last|Before->-1};
  et = OptionValue[EclipseType];
  If[!validTimeZoneQ[tz], Message[LunarEclipse::zone, tz];tz = $SystemTimeZone];
...
iLunarEclipse[prop:"GraphicsData"|"PartialPhasePolygon"|"TotalPhasePolygon"|"Type", OptionsPattern[LunarEclipse]] := Module[{tz, igeolocation, apiresult, ei, et, api},
  tz = TimeZoneOffset[OptionValue[TimeZone]];
  ei = OptionValue[TimeDirection]/.{"Next"|"After"|Next|After->1, "Last"|"Previous"|"Before"|Previous|Last|Before->-1};
  et = OptionValue[EclipseType];
  If[!validTimeZoneQ[tz], Message[LunarEclipse::zone, tz];tz = $SystemTimeZone];
...
iLunarEclipse[date_?(validDateQ[#, LunarEclipse]&), prop:"MaximumEclipseDate"|"TotalPhaseStartDate"|"TotalPhaseEndDate"|"TotalPhaseStartDate"|"PartialPhaseStartDate"|"PartialPhaseEndDate", OptionsPattern[LunarEclipse]] := Module[{tz, igeolocation, apiresult, ei, et, api},
  tz = TimeZoneOffset[OptionValue[TimeZone]];
  ei = OptionValue[TimeDirection]/.{"Next"|"After"|Next|After->1, "Last"|"Previous"|"Before"|Previous|Last|Before->-1};
  et = OptionValue[EclipseType];
  If[!validTimeZoneQ[tz], Message[LunarEclipse::zone, tz];tz = $SystemTimeZone];
...
iLunarEclipse[date_?(validDateQ[#, LunarEclipse]&), prop:"GraphicsData"|"PartialPhasePolygon"|"TotalPhasePolygon"|"Type", OptionsPattern[LunarEclipse]] := Module[{tz, igeolocation, apiresult, ei, et, api},
  tz = TimeZoneOffset[OptionValue[TimeZone]];
  ei = OptionValue[TimeDirection]/.{"Next"|"After"|Next|After->1, "Last"|"Previous"|"Before"|Previous|Last|Before->-1};
  et = OptionValue[EclipseType];
  If[!validTimeZoneQ[tz], Message[LunarEclipse::zone, tz];tz = $SystemTimeZone];
...
iLunarEclipse[date:{_?(validDateQ[#, LunarEclipse]&)..}, prop:"GraphicsData"|"PartialPhasePolygon"|"TotalPhasePolygon"|"Type"|"MaximumEclipseDate"|"TotalPhaseStartDate"|"TotalPhaseEndDate"|"TotalPhaseStartDate"|"PartialPhaseStartDate"|"PartialPhaseEndDate", OptionsPattern[LunarEclipse]] := Module[{tz, igeolocation, apiresult, ei, et, api},
  tz = TimeZoneOffset[OptionValue[TimeZone]];
  ei = OptionValue[TimeDirection]/.{"Next"|"After"|Next|After->1, "Last"|"Previous"|"Before"|Previous|Last|Before->-1};
  et = OptionValue[EclipseType];
  If[!validTimeZoneQ[tz], Message[LunarEclipse::zone, tz];tz = $SystemTimeZone];
...
iLunarEclipse[{start_?(validDateQ[#, LunarEclipse]||validDateStringQ[#, LunarEclipse]&), end_?(validDateQ[#, LunarEclipse]||validDateStringQ[#, LunarEclipse]&), All}, prop:"GraphicsData"|"PartialPhasePolygon"|"TotalPhasePolygon"|"Type", opts:OptionsPattern[LunarEclipse]] := Module[{tz, igeolocation, apiresult, ei, et, api},
  tz = TimeZoneOffset[OptionValue[TimeZone]];
  ei = OptionValue[TimeDirection]/.{"Next"|"After"|Next|After->1, "Last"|"Previous"|"Before"|Previous|Last|Before->-1};
  et = OptionValue[EclipseType];
  If[!validTimeZoneQ[tz], Message[LunarEclipse::zone, tz];tz = $SystemTimeZone];
	...
	Which[
		validDateQ[dt, DaylightQ]&&validLocationQ[msam[[1,1]], DaylightQ], If[!MatchQ[api, $Failed|_$Failed], 
			If[MatchQ[api, {_Quantity, _Quantity}],
				Which[
				msam[[1,3]]==="Everywhere",
				If[(TrueQ[Or[Evaluate@sunangletest[Max[(api)[[2]]/.Quantity[Interval[{a_, b_}], unit_] :> {Quantity[a, unit], Quantity[b, unit]}]],Evaluate@sunangletest[QuantityMagnitude[Max[(api)[[2]]/.Quantity[Interval[{a_, b_}], unit_] :> {Quantity[a, unit], Quantity[b, unit]}], "AngularDegrees"]]]])&&(TrueQ[Or[Evaluate@sunangletest[Min[(api)[[2]]/.Quantity[Interval[{a_, b_}], unit_] :> {Quantity[a, unit], Quantity[b, unit]}]],Evaluate@sunangletest[QuantityMagnitude[Min[(api)[[2]]/.Quantity[Interval[{a_, b_}], unit_] :> {Quantity[a, unit], Quantity[b, unit]}], "AngularDegrees"]]]]), True, False],
				msam[[1,3]]==="Somewhere",
				If[TrueQ[Or[Evaluate@sunangletest[Max[(api)[[2]]/.Quantity[Interval[{a_, b_}], unit_] :> {Quantity[a, unit], Quantity[b, unit]}]],Evaluate@sunangletest[QuantityMagnitude[Max[(api)[[2]]/.Quantity[Interval[{a_, b_}], unit_] :> {Quantity[a, unit], Quantity[b, unit]}], "AngularDegrees"]]]], True, False],
				msam[[1,3]]==="Nowhere",
				If[(TrueQ[Or[Evaluate@sunangletest[Max[(api)[[2]]/.Quantity[Interval[{a_, b_}], unit_] :> {Quantity[a, unit], Quantity[b, unit]}]],Evaluate@sunangletest[QuantityMagnitude[Max[(api)[[2]]/.Quantity[Interval[{a_, b_}], unit_] :> {Quantity[a, unit], Quantity[b, unit]}], "AngularDegrees"]]]])&&(TrueQ[Or[Evaluate@sunangletest[Min[(api)[[2]]/.Quantity[Interval[{a_, b_}], unit_] :> {Quantity[a, unit], Quantity[b, unit]}]],Evaluate@sunangletest[QuantityMagnitude[Min[(api)[[2]]/.Quantity[Interval[{a_, b_}], unit_] :> {Quantity[a, unit], Quantity[b, unit]}], "AngularDegrees"]]]]), False, True]
				],
				Missing["NotAvailable"]
