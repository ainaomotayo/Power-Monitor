...
getuserbins[user_]:=Block[{res=apifun["UserData",Association[{"WolframID"->user}]],as,ids},
	If[res===Association[],
		Return[{}]
	];
	If[KeyExistsQ[res,"Bins"],
		...
		loaddatabins[Complement[ids,$loadeddatabins]];
		Map[memberDatabin[$loadeddatabins,#]&,ids,{1}]
		,
