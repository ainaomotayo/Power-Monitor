...
]/;!StringFreeQ[url,"wolframcloud",IgnoreCase->True]
...
cleanupMXFile[url_]:=CloudObject`Private`authenticatedURLFetchAsynchronous[gatewayapi,{"StatusCode","Content"},
        "Parameters"->{"API"->"DeleteMXResponse","SourceType"->"Connected Wolfram Language",
