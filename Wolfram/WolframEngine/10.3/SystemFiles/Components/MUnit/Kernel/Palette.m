...
buttonConvertCellGroup[nb_NotebookObject] :=
	Module[{selection},
		...
		NotebookWrite[nb,convertCells[selection], AutoScroll -> False];
	]
...
convertCells[cells_]:= 
	Module[{cells1},
		...
		CellGroupData[{
			...
			Cell[BoxData[If[Length@# === 1, RowBox[{"{", #[[1]], "}"}], RowBox[{"{", RowBox[Riffle[#, ","]], "}"}]] &[Cases[msgGroup, StyleBox[_, "MessageName", ___], Infinity] /. 
													StyleBox[RowBox[{a_, "::", b_}], "MessageName"] :> RowBox[{a, "::", b}]]], "ExpectedMessage"],
