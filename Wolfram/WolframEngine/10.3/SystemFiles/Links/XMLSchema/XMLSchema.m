...
XMLSchema`Information`$CreationID = If[SyntaxQ["136"], ToExpression["136"], 0]
XMLSchema`Information`$CreationDate = If[SyntaxQ["{2015, 12, 27, 20, 53, 03}"], ToExpression["{2015, 12, 27, 20, 53, 03}"], {0,0,0,0,0,0}]
