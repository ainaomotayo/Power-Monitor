...
TetGenImport[ file_String, TetGenExpression[ id_]?(testTetGenExpression[TetGenImport]), form_String] :=
...
TetGenExport[ file_String, TetGenExpression[ id_]?(testTetGenExpression[TetGenExport]), form_String] :=
	Module[{res, formName, fileName, fileWithExtension,
		fns, newDir, validDirQ},
		formName = Switch[ form,
						"node", "save_nodes",
...
TetGenImport[ file_String, TetGenExpression[ id_]?(testTetGenExpression[TetGenImport])] :=
...
TetGenExport[ file_String, TetGenExpression[ id_]?(testTetGenExpression[TetGenExport])] :=
	Module[{dir, fileName, ext},
		dir = FileNameDrop[ file, -1];
		fileName = FileBaseName[ file];
		ext = FileExtension[file];
