...
GPUFunctionLoad[functionHd_, progObjHd_, errMsgHd_, prog:{_} /; !StringQ[First@prog], ___] :=
	Throw[Message[errMsgHd::invprog, First[prog]]; $Failed]
GPUFunctionLoad[functionHd_, progObjHd_, errMsgHd_, prog_ /; (!StringQ[prog] && !ListQ[prog]), ___] :=
...
GPUFunctionLoad[functionHd_,
	...
	Module[{progObj, platform, device, defines, systemDefines, args,
		    ...
		    targetPrecision, buildOptions, binaryQ, source, optRes, res},
		optRes = Catch[
