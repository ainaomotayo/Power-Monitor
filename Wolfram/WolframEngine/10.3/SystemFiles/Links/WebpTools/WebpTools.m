...
{FileNameJoin[{$InstallationDirectory, "SystemFiles", "Links", 
   ...
   $ReadImageWebpFun = LibraryFunctionLoad[WebpToolsdll, "ReadImageWebp", {"UTF8String"}, {_Integer, 3}];
   $ReadICCWebpFun = LibraryFunctionLoad[WebpToolsdll, "ReadICCWebp", {"UTF8String"}, {_Integer, 1}];
   $WriteImageWebpFun = LibraryFunctionLoad[WebpToolsdll, "WriteImageWebp", {{"UTF8String"}, {_Integer, 3}, _Integer}, "UTF8String"];
