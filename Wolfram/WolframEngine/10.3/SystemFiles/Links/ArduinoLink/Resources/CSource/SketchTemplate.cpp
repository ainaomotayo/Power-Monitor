...
/* UNIMPLEMENTED*/
/**
    getStringArrayArgNum - gets the number of string array arguments

    To get the number of string array args, we take the high nibble of the 
    numStringArrayAnd2DStringArrayArgs member of the struct
*/
/*
byte getStringArrayArgNum( arguments * args )
{*/
    /*to get the high nibble of numStringArrayAnd2DStringArrayArgs, we bit shift it to the right 4*/
  /*  return (args->numStringArrayAnd2DStringArrayArgs) >> 4;
}
*/
...
/**
    get2DLongArrayArgNum - gets the number of 2D long array arguments

    To get the number of 2D long array arguments, we take the low nibble of the 
    numLongArrayAnd2DLongArrayArgs member of the struct
*/
/*
byte get2DLongArrayArgNum( arguments * args)
{*/
    /*to get the low nibble of numLongArrayAnd2DLongArrayArgs, we bitwise and it with 0b00001111*/
   /* return (args->numLongArrayAnd2DLongArrayArgs) & 15;
}
*/
...
/* UNIMPLEMENTED*/
/**
    get2DFloatArrayArgNum - gets the number of 2D float array arguments

    To get the number of 2D float array arguments, we take the low nibble of the 
    numFloatArrayAnd2DFloatArrayArgs member of the struct
*/
/*
byte get2DFloatArrayArgNum( arguments * args)
{*/
    /*to get the low nibble of numFloatArrayAnd2DFloatArrayArgs, we bitwise and it with 0b00001111*/
    /*return (args->numFloatArrayAnd2DFloatArrayArgs) & 15;
}
*/
...
/*UNIMPLEMENTED*/
/**
    get2DStringArrayArgNum - gets the number of 2D string array arguments

    To get the number of 2D string array arguments, we take the low nibble of the 
    numStringArrayAnd2DStringArrayArgs member of the struct
*/
/*
byte get2DStringArrayArgNum( arguments * args)
{*/
   /* to get the low nibble of numStringArrayAnd2DStringArrayArgs, we bitwise and it with 0b00001111*/
    /*return (args->numStringArrayAnd2DStringArrayArgs) & 15;
}
*/
...
/*UNIMPLEMENTED*/
/**
    setStringArrayArgNum - sets the number of string array arguments

    To set the number of string array arguments, we have to set the high nibble of
    the numStringArrayAnd2DStringArrayArgs member of the struct to be what the user passed in

    @param numStringArrays - the number of string arrays
*/
/* void setStringArrayArgNum( arguments * args, byte numStringArrays)*/
/* {*/
    /* to set the high nibble of numStringArrayAnd2DStringArrayArgs, we first clear the high */
    /* nibble by bitwise anding numStringArrayAnd2DStringArrayArgs with 0b00001111 (15), then */
    /* bitshifting numStringArrays to the left 4, and bitwise oring the two together*/
    /* args->numStringArrayAnd2DStringArrayArgs =  ((args->numStringArrayAnd2DStringArrayArgs) & 15) */
                                                                                    /* | (numStringArrays << 4 );*/
    /* we also have to increment the low nibble of numStringAndArrayArgs by whatever the user*/
    /* passed*/
    /* args->numStringAndArrayArgs = (args->numStringAndArrayArgs & 240) |*/
                                                                    /* (((args->numStringAndArrayArgs & 15) + */
                                                                            /* numStringArrays) & 15);*/
/* }*/
...
/*UNIMPLEMENTED*/
/**
    set2DLongArrayArgNum - sets the number of 2D long array arguments

    To set the number of 2D long array arguments, we have to set the low nibble of 
    the numLongArrayAnd2DLongArrayArgs member of the struct to be what the user passed in

    @param numLong2DArrays - number of 2D long arrays
*/

/* void set2DLongArrayArgNum( arguments * args, byte numLong2DArrays)*/
/* {*/
    /* to set the low nibble of numLongArrayAnd2DLongArrayArgs, we first clear the low nibble*/
    /* by bitwise anding numLongArrayAnd2DLongArrayArgs with 0b11110000 (240), then bitwise and*/
    /* numLong2DArrays with 0b00001111 (15) and finally bitwise or the two together*/
    /* args->numLongArrayAnd2DLongArrayArgs = ((args->numLongArrayAnd2DLongArrayArgs) & 240)*/
                                                                            /* | (numLong2DArrays & 15);*/
    /* we also have to increment the low nibble of numStringAndArrayArgs by whatever the user*/
    /* passed*/
    /* args->numStringAndArrayArgs = (args->numStringAndArrayArgs & 240) |*/
...
/*UNIMPLEMENTED*/
/**
    set2DFloatArrayArgNum - sets the number of 2D float array arguments

    To set the number of 2D float array arguments, we have to set the low nibble of 
    the numFloatArrayAnd2DFloatArrayArgs member of the struct to be what the user passed in

    @param numFloat2DArrays - number of 2D float arrays
*/
/* void set2DFloatArrayArgNum( arguments * args, byte numFloat2DArrays)*/
/* {*/
    /* to set the low nibble of numFloatArrayAnd2DFloatArrayArgs, we first clear the low nibble*/
    /* by bitwise anding numFloatArrayAnd2DFloatArrayArgs with 0b11110000 (240), then bitwise and*/
    /* numLong2DArrays with 0b00001111 (15) and finally bitwise or the two together*/
    /* args->numFloatArrayAnd2DFloatArrayArgs = ((args->numFloatArrayAnd2DFloatArrayArgs) & 240)*/
                                                                            /* | (numFloat2DArrays & 15);*/
    /* we also have to increment the low nibble of numStringAndArrayArgs by whatever the user*/
    /* passed*/
    /* args->numStringAndArrayArgs = (args->numStringAndArrayArgs & 240) |*/
...
/*UNIMPLEMENTED*/
/**
    set2DStringArrayArgNum - sets the number of 2D string array arguments

    To set the number of 2D string array arguments, we have to set the low nibble of 
    the numStringArrayAnd2DStringArrayArgs member of the struct to be what the user passed in

    @param numString2DArrays - number of 2D string arrays
*/
/* void set2DStringArrayArgNum( arguments * args, byte numString2DArrays)*/
/* {*/
    /* to set the low nibble of numStringArrayAnd2DStringArrayArgs, we first clear the low nibble*/
    /* by bitwise anding numStringArrayAnd2DStringArrayArgs with 0b11110000 (240), then bitwise and*/
    /* numLong2DArrays with 0b00001111 (15) and finally bitwise or the two together*/
    /* args->numStringArrayAnd2DStringArrayArgs = ((args->numStringArrayAnd2DStringArrayArgs) & 240)*/
                                                                            /* | (numString2DArrays & 15);*/
    /* we also have to increment the low nibble of numStringAndArrayArgs by whatever the user*/
    /* passed*/
    /* args->numStringAndArrayArgs = (args->numStringAndArrayArgs & 240) |*/
                                                                    /* (((args->numStringAndArrayArgs & 15) + */
...
/*UNIMPLEMENTED*/
/**
    getStringArrayArgArray - gets an array of arrays of string argument
*/
/* char * getStringArrayArgArray( arguments * args)*/
/*{*/
    /*just return the member*/
   /* return args->stringArrayArgs;
}
 */
 ...
 /*UNIMPLEMENTED*/
/**
    get2DLongArrayArgArray - gets an array of 2D arrays of longs arguments
*/
/* long * get2DLongArrayArgArray( arguments * args)*/
/* { */
    /*just return the member*/
 /*   return args->long2DArrayArgs;
}
 */

 /*UNIMPLEMENTED*/ 
/**
    get2DFloatArrayArgArray - gets an array of 2D arrays of floats arguments
*/
/* float * get2DFloatArrayArgArray( arguments * args)*/
/* { */
    /*just return the member*/
  /*  return args->float2DArrayArgs;
}
 */
...
/*UNIMPLEMENTED*/
/**
    get2DStringArrayArgArray - gets an array of 2D arrays of strings arguments
*/
/* char * get2DStringArrayArgArray( arguments * args)*/
/* { */
    /*just return the member*/
  /*  return args->string2DArrayArgs;
}
 */
...
void firmataDigitalReadPacketSend(byte port, byte value)
{
	...
	Serial.write(DIGITAL_WRITE_TASK | (port & 15));
...
void firmataTaskStringSend(char * data)
{
	...
	Serial.write(stringLength & 127);
	Serial.write((stringLength & 16256) >> 7);
...
void readTaskRun(task * readTask, byte * pinConfigurations)
{
	...
	else
	{
		...
		{
			case 0:
				/*PORTD (note we ignore pins 0 and 1 as those are for Serial communication)*/
...
void writeTaskRun(task * writeTask, byte * pinConfigurations)
{
	...
	else
	{
		...
		switch(port)
		{
			...
			/*bitwise and*/
			case 0:
				/*PORTD (note we skip pins 0 and 1 as they are reserved for Serial communication)*/
				if(!(pinConfigurations[0] & 4) || (DDRD & 4) )
				{
					/*digital pin 2*/
...
void sendOutOfMemoryMessage()
{
	/*send a firmata sysex message which represents an out of memory response*/
	/*UNIMPLEMENTED*/
	/*Serial.write(SYSEX_START);*/
	/*Serial.write(OUT_OF_MEMORY);*/
	/*Serial.write(SYSEX_END);*/
}
...
{
	/*this function will read in from the Serial buffer enough bytes until it gets one full task.*/
	/*it will not disturb further bytes in the Serial buffer*/
	...
	switch(taskHighNibble)
	{
		...
		case ANALOG_WRITE_TASK:
			...
			while(Serial.available()<=0);
			lowAnalogVal = Serial.read();
			while(Serial.available()<=0);
			highAnalogVal = Serial.read();
					...
					switch(Serial.read())
					{
						...
						case FUNCTION_CALL_ADD:
							...
							if(validFunctionID(functionID))
							{
								...
								/*we are going to grab the rest off the data for this packet off of the Serial port*/
	...
	switch(type)
	{
		case 1:
			...
			while(1)
			{
				...
				/*next check Serial buffer for new tasks*/
				if(Serial.available())
				{
					/*there's new data on the Serial port*/
		...
		case 4:
			...
			for (callCount = getIterationCount(functionTask); callCount--;)
			{
				...
				/*loop through the checking code for Serial.available() until the time has*/
				...
				while(1)
				{
					...
					if(Serial.available()&&callCount>1)
					{
						/*there's new data on the Serial port*/
						newTask = getSerialFirmataTask();
						/*check to make sure it is a legit task*/
...
void loop()
{
  /*main event loop*/
      ...
      while(1)
      {
		...
		}/*end else block for no Serial.available()*/
      }/*end infinite while loop*/
}
