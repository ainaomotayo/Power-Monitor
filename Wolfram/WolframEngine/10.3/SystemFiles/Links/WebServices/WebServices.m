...
WebServices`Information`$CreationID = If[SyntaxQ["138"], ToExpression["138"], 0]
WebServices`Information`$CreationDate = If[SyntaxQ["{2015, 12, 27, 20, 29, 14}"], ToExpression["{2015, 12, 27, 20, 29, 14}"], {0,0,0,0,0,0}]
