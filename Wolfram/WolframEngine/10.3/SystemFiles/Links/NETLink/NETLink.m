...
(* :Copyright: NET/Link source code (c) 2003-2015, Wolfram Research, Inc. All rights reserved.
...
`Information`$ReleaseNumber = 2
`Information`$Version = "NET/Link Version 1.6.2"
`Information`$CreationDate = {2015, 12, 27, 20, 3, 12.3822403}
`Information`$CreationID = 2015122701
